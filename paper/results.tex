...
The obtained performaces are quite satisfying: we get $76.2$\% accuracy
...
Sec. \ref{subsec:autoencoder} with hyperparameters selected in
...
data preprocessing could leat to good results even with new problem
settings.
