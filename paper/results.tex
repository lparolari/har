...
on the user's style in walking, doing stairs and so on. In this way we
...
CNN was of nearly $45$\% for all metrics!  As
Tab. \ref{tab:model-oit-performance} confirms, combining the power of
the CNN with automatically extracted features and smart data
preprocessing could lead to good results even with new problem
settings.
