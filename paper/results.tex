...
Due to time reasons we do not further investigate the FFNN model.
...
OD as a test set. It is important to remember that in this case we condensed the \textit{sit} and \textit{stand} activities of HD into a one class \textit{no activity} category, since OIT makes these two stationary activities indistinguishable from each other.
