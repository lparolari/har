...
TODO: SPOSTARE QUESTA PARTE IN RESULTS
...
first is a K-Nearest Neighbors (KNN) clustering algorithm, and we
...
class by class. We perform a grid search for metric and number of
neighbors, values are reported in Tab.~\ref{tab:knn-grid-search}. We
