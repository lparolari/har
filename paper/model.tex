...
For our application we decided to use the dataset described in
...
We also collect a novel dataset in order to perform a cross-dataset
validation. The goal is to see whether the models can generalize well
on new new users and also on new smartphone positions. This dataset
(\textit{Bryan dataset}) is collected with a sampling rate of 100 Hz
with seven smartphone positions: top, bottom, left, right, hand,
